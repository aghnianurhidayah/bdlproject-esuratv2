...
<body style="margin: 0px 50px;">
    ...
    <div class="title-surat">
        <h4 style="font-size: 18px; text-align: center;"><u>SURAT KETERANGAN TIDAK MAMPU</u></h4>
    ...
    <div class="content-surat" style="font-size: 18px; margin: 50px 0">
        ...
        <p>Adalah benar-benar warga kami dan berdomisili di Desa Suka Maju Kecamatan Kongbeng Kabupaten Kutai Timur. Berdasarkan keterangan yang ada pada kami bentar bahwa yang bersangkutan tergolong Keluarga Tidak Mampu.</p>
