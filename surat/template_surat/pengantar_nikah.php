...
<body style="margin: 0px 50px;">
    ...
    <div class="title-surat">
        <h4 style="font-size: 18px; text-align: center;"><u>SURAT PENGANTAR NIKAH</u></h4>
    ...
    <div class="content-surat" style="font-size: 18px; margin: 50px 0">
        ...
        <p>Adalah anggota masyarakat Desa Suka Maju dengan status Belum Menikah. Surat pengantar ini dipergunakan untuk mengurus Administrasi Pernikahan.</p>
        <p>Demikian surat pengantar ini dibuat dan diserahkan kepada yang bersangkutan untuk dapat dipergunakan seperlunya.</p>
    </div>
