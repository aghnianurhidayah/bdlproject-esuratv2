...
<head>
    ...
    <title>Surat Pernyataan Tidak Memiliki Akta Kelahiran</title>
...
<body style="margin: 0px 50px;">
    ...
    <div class="title-surat">
        <h4 style="font-size: 18px; text-align: center;"><u>SURAT KETERANGAN TIDAK MEMILIKI AKTA KELAHIRAN</u></h4>
    ...
    <div class="content-surat" style="font-size: 18px; margin: 50px 0">
        ...
        <p>Dengan ini menyatakan bahwa sampai saat ini belum memiliki Akta Kelahiran, dan bersedia mengajukan Akta Kelahiran setelah proses perubahan KK selesai.</p>
