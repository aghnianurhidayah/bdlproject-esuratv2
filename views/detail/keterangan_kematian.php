...
if (!(isset($_SESSION['role']))) {
    ...
    if (isset($_POST['accform'])) {
        ...
        $update_form = "UPDATE sk_kematian SET no_kk = '$nokk', nama = '$nama', tgl_lahir = '$tl', tgl_meninggal = '$tm', jenis_kelamin = '$jk', agama = '$agama', alamat = '$alamat', file_kk = '$file_kk', file_ktp = '$file_ktp' WHERE skm_id = '$surat_id'";
...
?>
<div class="form">
    <form action="detail/keterangan_kematian.php?surat_id=<?= $surat_id ?>" method="post" enctype="multipart/form-data">
        <div class="input-box">
        ...
        <div class="input-box d-none" id="input-nik">
            ...
            <input type="number" name="nik" id="nik" class="textfield" value="<?= $surat['nik'] ?>" onkeypress="isInputNumber(event)" minlength="16" maxlength="16" class="textfield" placeholder="Masukan No. KK" <?= ($_SESSION['role'] == 'admin' ? 'disabled' : '') ?>>
        </div>
        ...
        <div class="input-box d-none" id="input-fktp">
            ...
            <input type="file" name="fktp" id="fktp" class="filefield" placeholder="Upload File KTP" <?= ($_SESSION['role'] == 'admin' ? 'disabled' : '') ?>>
        </div>
        <div class="btn-op">
