...
if (!(isset($_SESSION['role']))) {
    ...
    if ($_SESSION['role'] == "user") {
        ...
        if (isset($_POST['editform'])) {
            ...
            $update_form = "UPDATE sk_kematian SET nik = '$nik', no_kk = '$nokk', nama = '$nama', tgl_lahir = '$tl', tgl_meninggal = '$tm', jenis_kelamin = '$jk', agama = '$agama', alamat = '$alamat', file_kk = '$file_kk', file_ktp = '$file_ktp' WHERE skm_id = '$surat_id'";
