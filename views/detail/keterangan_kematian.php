...
<div class="form">
    <form action="detail/keterangan_kematian.php?surat_id=<?= $surat_id ?>" method="post" enctype="multipart/form-data">
        ...
        <div class="input-box d-none" id="input-nik">
            ...
            <input type="number" name="nik" id="nik" class="textfield" value="<?= $surat['nik'] ?>" onkeypress="isInputNumber(event)" minlength="16" maxlength="16" class="textfield" placeholder="Masukan No. KK">
        </div>
        ...
        <div class="input-box d-none" id="input-tk">
            ...
            <input type="date" name="tk" id="tk" class="textfield" value="<?= $surat['tgl_meninggal'] ?>" placeholder="Masukan Tanggal Kematian">
        </div>
