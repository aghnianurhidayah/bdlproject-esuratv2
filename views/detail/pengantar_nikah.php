...
if (!(isset($_SESSION['role']))) {
    ...
    if (isset($_POST['accform'])) {
        ...
        $update_form = "UPDATE sp_nikah SET nik = '$nik', no_kk = '$nokk', nama = '$nama', tgl_lahir = '$tl', jenis_kelamin = '$jk', agama = '$agama', alamat = '$alamat', pekerjaan = '$pekerjaan', kewarganagaraan = '$wn', file_kk = '$file_kk', file_ktp = '$file_ktp', file_foto = '$file_foto' WHERE sp_nikah_id = '$surat_id'";
...
<div class="form">
    <form action="detail/pengantar_nikah.php?surat_id=<?= $surat_id ?>" method="post" enctype="multipart/form-data">
        <div class="input-box">
        ...
        <div class="input-box">
            <img src="/e-suratv2/img/foto/<?= $surat['file_foto'] ?>" alt="" width="50%">
        </div>
