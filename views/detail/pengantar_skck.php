...
if (!(isset($_SESSION['role']))) {
    ...
    if ($_SESSION['role'] == "user") {
        ...
        if (isset($_POST['editform'])) {
            ...
            $update_form = "UPDATE sp_skck SET nik = '$nik', no_kk = '$nokk', nama = '$nama', tgl_lahir = '$tl', jenis_kelamin = '$jk', agama = '$agama', alamat = '$alamat', pekerjaan = '$pekerjaan', kewarganagaraan = '$wn', file_kk = '$file_kk', file_ktp = '$file_ktp', file_foto = '$file_foto' WHERE sp_skck_id = '$surat_id'";
