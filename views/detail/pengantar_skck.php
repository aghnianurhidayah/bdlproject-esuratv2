...
$get = mysqli_query($conn, "SELECT * FROM surat JOIN sp_skck ON surat.surat_id = sp_skck.sp_skck_id WHERE surat_id = '$surat_id'");
$surat = [];
...
if (!(isset($_SESSION['role']))) {
    ...
    if (isset($_POST['accform'])) {
        ...
        $update_form = "UPDATE sp_skck SET nik = '$nik', no_kk = '$nokk', nama = '$nama', tgl_lahir = '$tl', jenis_kelamin = '$jk', agama = '$agama', alamat = '$alamat', pekerjaan = '$pekerjaan', file_ktp = '$file_ktp' WHERE sp_skck_id = '$surat_id'";
...
?>
<div class="form">
    <form action="detail/pengantar_skck.php?surat_id=<?= $surat_id ?>" method="post" enctype="multipart/form-data">
        <div class="input-box">
