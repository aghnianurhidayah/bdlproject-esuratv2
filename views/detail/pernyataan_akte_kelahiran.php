...
if (!(isset($_SESSION['role']))) {
    ...
    if ($_SESSION['role'] == "user") {
        ...
        if (isset($_POST['editform'])) {
            ...
            $update_form = "UPDATE spn_akte_kelahiran SET no_kk = '$nokk', nama = '$nama', tgl_lahir = '$tl', jenis_kelamin = '$jk', agama = '$agama', alamat = '$alamat', kewarganagaraan = '$wn', nama_ayah = '$ayah', nama_ibu = '$ibu', file_kk = '$file_kk' WHERE spn_akte_kelahiran_id = '$surat_id'";
