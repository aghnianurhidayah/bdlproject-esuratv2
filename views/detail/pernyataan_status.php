...
if (!(isset($_SESSION['role']))) {
    ...
    if ($_SESSION['role'] == "user") {
        ...
        $get = mysqli_query($conn, "SELECT * FROM surat JOIN spn_status_perwalian ON surat.surat_id = spn_status_perwalian.spn_status_perwalian_id WHERE surat_id = '$surat_id'");
        $surat = [];
